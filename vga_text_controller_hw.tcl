...
# Sat Jun 06 18:26:44 CST 2026
# DO NOT MODIFY


# 
# vga_text_controller "VGA Text Controller" v1.0
#  2026.06.06.18:26:44
# 
# 
...
set_module_property DISPLAY_NAME "VGA Text Controller"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL vga_text_controller
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file vga_text_controller.sv SYSTEM_VERILOG PATH vga_text_controller.sv TOP_LEVEL_FILE
add_fileset_file char_renderer.sv SYSTEM_VERILOG PATH char_renderer.sv
add_fileset_file vga_timing.sv SYSTEM_VERILOG PATH vga_timing.sv
add_fileset_file text_buffer.sv SYSTEM_VERILOG PATH text_buffer.sv
...
add_interface_port avl avl_address address Input 12
...
add_interface_port avl avl_byteenable byteenable Input 4
...
add_interface_port vga vga_clk clk_pixel Output 1
