# qsys scripting (.tcl) file for hps
...
set_instance_parameter_value audio_and_video_config_0 {board} {DE10-Standard}
...
set_instance_parameter_value audio_and_video_config_0 {eai} {0}
...
set_instance_parameter_value hps_0 {MPU_EVENTS_Enable} {1}
...
set_instance_parameter_value hps_0 {UART0_Mode} {Flow Control}
...
# exported interfaces
add_interface audio_0_external_interface conduit end
set_interface_property audio_0_external_interface EXPORT_OF audio_0.external_interface
add_interface avalon_mm_master avalon master
set_interface_property avalon_mm_master EXPORT_OF mm_bridge_0.m0
add_interface clk clock sink
set_interface_property clk EXPORT_OF clk_0.clk_in
add_interface hpf_reset reset source
set_interface_property hpf_reset EXPORT_OF hps_0.h2f_reset
...
add_connection hps_0.h2f_axi_master audio_0.avalon_audio_slave
set_connection_parameter_value hps_0.h2f_axi_master/audio_0.avalon_audio_slave arbitrationPriority {1}
set_connection_parameter_value hps_0.h2f_axi_master/audio_0.avalon_audio_slave baseAddress {0x0000}
set_connection_parameter_value hps_0.h2f_axi_master/audio_0.avalon_audio_slave defaultConnection {0}
...
add_connection jtag_master.master mm_bridge_0.s0
set_connection_parameter_value jtag_master.master/mm_bridge_0.s0 arbitrationPriority {1}
set_connection_parameter_value jtag_master.master/mm_bridge_0.s0 baseAddress {0x0000}
set_connection_parameter_value jtag_master.master/mm_bridge_0.s0 defaultConnection {0}
